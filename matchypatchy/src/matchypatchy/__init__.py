...
__all__ = ['AboutPopup', 'AlertPopup', 'AnimlThread', 'BuildManifestThread',
           ...
           'VideoPlayerBar', 'VideoViewer', 'VideoWidget', 'add',
           'animl_thread', 'check_missing_thumbnails', 'config', 'database',
           'delete', 'dialogs', 'display_base', 'display_compare',
