...
class MLDownloadPopup(QDialog):
    ...
    def toggle_open(self):
        ...
        self.buttonBox.setEnabled(True)  # Disable the OK button
    
    def toggle_closed(self):
        #ok_button = self.buttonBox.button(QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setEnabled(False)  # Disable the OK button
    ...
    def download_ml(self):
        ...
        self.build_thread.finished.connect(self.toggle_open)
