...
from matchypatchy.gui.widgets import (ClickableSlider, ComboBoxDelegate,
                                      ...
                                      ImageWidget, MediaWidget,
                                      SequenceSelector, SliderWithLabel,
                                      StandardButton, TextEditWithSignal,
...
__all__ = ['AlertPopup', 'ClickableSlider', 'ComboBoxDelegate',
           ...
           'QueryContainer', 'READMEPopup', 'SequenceSelector',
           'SliderWithLabel', 'StandardButton', 'StationFillPopup',
           'StationPopup', 'SurveyFillPopup', 'SurveyPopup',
           'TextEditWithSignal', 'ThreePointSlider', 'UploadManagerPopup',
           ...
           'popup_survey', 'popup_uploads', 'qc_query', 'query',
